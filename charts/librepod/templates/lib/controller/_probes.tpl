...
*/}}
{{- define "librepod.controller.probes" -}}
{{- $primaryService := get .Values.service (include "librepod.service.primary" .) -}}
{{- $primaryPort := "" -}}
{{- if $primaryService -}}
  {{- $primaryPort = get $primaryService.ports (include "librepod.classes.service.ports.primary" (dict "serviceName" (include "librepod.service.primary" .) "values" $primaryService)) -}}
{{- end -}}
